                ...
                case 1 ->{
                    ...
                    switch (tipoContaBancaria) {
                        case 1 -> {
                            ...
                            ContaBancaria novaContaCorrente = new ContaCorrente(nome, numeroConta, saldo, limite);
                        ...
                        case 2 -> {
                            ...
                            ContaBancaria novaContaPoupanca = new ContaPoupanca(nome, numeroConta, saldo, diaRendimento);
                            contasBancarias.add(novaContaPoupanca);
                        }
                        case 3 -> {
                            ContaBancaria novaContaInvestimento = new ContaInvestimento(nome, numeroConta, saldo);
