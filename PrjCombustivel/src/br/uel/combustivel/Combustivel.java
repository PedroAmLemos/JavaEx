...
public class Combustivel {
	...
	public double absLitro(double qntLitro) {
		...
		System.out.println("O preco de "+ qntLitro+ " litros da gasolina "+ this.nomeCombustivel +" é "+preco +" reais");
		return preco;
	}
	
	public double absDin(double qntDin) {
		double qntLitro = qntDin / preco;
		System.out.println("Foram abastecidos "+ qntLitro +" litros " + "com " +qntDin +" reais, a gasolina utilizada foi a " +this.nomeCombustivel);
		return qntLitro;
	}
